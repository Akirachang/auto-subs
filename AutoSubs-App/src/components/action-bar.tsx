...
export function ActionBar({
  ...
  const [languageTab, setLanguageTab] = React.useState<"source" | "translate">(
    "source",
  );
  ...
  const [openPunctuationDialog, setOpenPunctuationDialog] =
    React.useState(false);
    ...
    <Card className="p-3 space-y-3 sticky bottom-4 mx-4">
      <div className="grid w-full gap-3">
          ...
          <Popover open={openLanguage} onOpenChange={setOpenLanguage}>
            ...
            <PopoverContent className="p-0 w-72" align="start" side="top">
              <Tabs
                value={languageTab}
                onValueChange={(value) =>
                  setLanguageTab(value as "source" | "translate")
                }
              >
                <TabsContent value="source" className="mt-0 border-b">
                  <Command className="max-h-[250px]">
                    <CommandInput
                      placeholder={t(
                        "actionBar.language.searchSourcePlaceholder",
                      )}
                    />
                    <CommandList>
                      <CommandEmpty>
                ...
                <TabsContent value="translate" className="mt-0 border-b">
                  <Command className="max-h-[250px] relative">
                    <div className="relative">
                      <CommandInput
                        placeholder={t(
                          "actionBar.language.searchTargetPlaceholder",
                        )}
                        className="border-0 focus-visible:ring-0 px-0 pr-12"
                      />
                      <Button
                        size="sm"
                        ...
                        onClick={() =>
                          updateSetting("translate", !settings.translate)
                        }
                      >
                        {settings.translate
                          ? t("actionBar.common.on")
              ...
              <div className="px-4 py-5">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-sm font-medium ${settings.enableDiarize ? "text-primary" : "text-red-500"}`}
                    >
                      {settings.enableDiarize
                        ? settings.maxSpeakers === null
                          ? t("actionBar.common.auto")
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) =>
                      settings.enableDiarize &&
                      updateSetting("maxSpeakers", value === 0 ? null : value)
                    }
                    max={10}
                    min={0}
                    step={1}
              ...
              <div className="space-y-3 p-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {t("actionBar.format.removePunctuationDescription")}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Dialog
                      open={openPunctuationDialog}
                      onOpenChange={setOpenPunctuationDialog}
                    >
                      ...
                      <DialogContent className="sm:max-w-[520px]">
                        ...
                        <ScrollArea className="max-h-[220px] rounded-md border bg-muted/20 p-3">
                          <div className="space-y-3">
                            {[
                              {
                                key: "periods",
                              ...
                              <div key={key} className="flex items-center">
                                <input
                                  id={`punct-${key}`}
                                  type="checkbox"
                                  checked={settings.removePunctuation.includes(
                                    key,
                                  )}
                                  onChange={(e) => {
                                    const current = settings.removePunctuation;
                                    if (e.target.checked) {
                                      updateSetting("removePunctuation", [
                                        ...current,
                                        key,
                                      ]);
                                    } else {
                                ...
                                <label
                                  htmlFor={`punct-${key}`}
                                  className="ms-2 text-sm font-medium select-none cursor-pointer"
                                >
                                  {label}
                                </label>
                              </div>
                    ...
                    <Switch
                      checked={settings.removePunctuation.length > 0}
                      onCheckedChange={(checked) => {
                        if (checked) {
                          updateSetting("removePunctuation", [
                            "periods",
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-medium">
                      {t("actionBar.censor.title")}
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      {t("actionBar.censor.wordCount", {
                        count: (settings.censoredWords || []).length,
                      })}
                  ...
                  <div className="flex items-center gap-2">
                    <Dialog
                      open={openCensorDialog}
                      onOpenChange={setOpenCensorDialog}
                    >
                      <DialogTrigger asChild>
                        <Button variant="ghost" size="icon" className="h-8 w-8">
                          <Settings2 className="h-4 w-4" />
                      ...
                      <DialogContent className="sm:max-w-[520px]">
                        <DialogHeader>
                          <DialogTitle>
                            {t("actionBar.censor.dialogTitle")}
                          </DialogTitle>
                          <DialogDescription>
                        ...
                        <div className="grid gap-4">
                          <form
                            ...
                            onSubmit={(e) => {
                              e.preventDefault();
                              if (
                                !newCensoredWord.trim() ||
                                (settings.censoredWords || []).includes(
                                  newCensoredWord.trim(),
                                )
                              )
                                return;
                              updateSetting("censoredWords", [
                          ...
                          >
                            <Input
                              ...
                              onChange={(e) =>
                                setNewCensoredWord(e.target.value)
                              }
                              placeholder={t(
                                "actionBar.censor.inputPlaceholder",
                              )}
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("enableCensor", checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-sm font-medium">
                      {t("actionBar.format.textCaseTitle")}
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      {t("actionBar.format.textCaseDescription")}
                    </p>
                  </div>
                  <div className="w-36">
                    <Select
                    ...
                    >
                      ...
                      <SelectContent align="end">
                        <SelectItem value="none">
                          {t("actionBar.format.textCase.normal")}
                        </SelectItem>
                        <SelectItem value="lowercase">
                          {t("actionBar.format.textCase.lowercase")}
                        </SelectItem>
                        <SelectItem value="uppercase">
                          {t("actionBar.format.textCase.uppercase")}
                        </SelectItem>
                        <SelectItem value="titlecase">
                          {t("actionBar.format.textCase.titleCase")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-sm font-medium">
                      {t("actionBar.format.characterLimitTitle")}
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      {t("actionBar.format.characterLimitDescription")}
                    </p>
                  </div>
                  <Input
                    type="number"
                    ...
                    onChange={(e) =>
                      updateSetting("maxCharsPerLine", Number(e.target.value))
                    }
                    className="w-20"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-sm font-medium">
                      {t("actionBar.format.lineCountTitle")}
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      {t("actionBar.format.lineCountDescription")}
                    </p>
                  </div>
                  <Input
                    type="number"
        ...
        {!settings.isStandaloneMode ? (
          ...
          <Popover
            open={openTrackSelector}
            onOpenChange={handleTrackSelectorOpen}
          >
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                    ...
                    {settings.selectedInputTracks.length === 0
                      ...
                      : settings.selectedInputTracks.length === 1
                        ? t("actionBar.tracks.trackN", {
                            n: settings.selectedInputTracks[0],
                          })
                        : t("actionBar.tracks.countSelected", {
                            count: settings.selectedInputTracks.length,
                          })}
                  </div>
                  <span className="text-xs text-muted-foreground">
                    {t("actionBar.tracks.selectMultiple")}
                  </span>
                </div>
              </Button>
            </PopoverTrigger>
            <PopoverContent
              className="min-w-[320px] p-0 overflow-hidden"
              align="center"
            >
                ...
                <div className="px-4 py-2 bg-gradient-to-br from-red-50/80 to-orange-50/80 dark:from-red-950/50 dark:to-orange-950/50 border-b">
                  <div className="flex items-center justify-between min-h-[28px]">
                          ...
                          ? t("actionBar.tracks.selectedLabel", {
                              label:
                                inputTracks.find(
                                  (track) =>
                                    track.value ===
                                    settings.selectedInputTracks[0],
                                )?.label ||
                                t("actionBar.tracks.trackN", {
                                  n: settings.selectedInputTracks[0],
                                }),
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (
                          settings.selectedInputTracks.length ===
                          inputTracks.length
                        ) {
                          ...
                          updateSetting(
                            "selectedInputTracks",
                            inputTracks.map((track) => track.value),
                          );
                        }
                      }}
                    >
                      {settings.selectedInputTracks.length ===
                      inputTracks.length
                        ? t("actionBar.tracks.clearAll")
                        : t("actionBar.tracks.selectAll")}
                    </Button>
                  </div>
                </div>
              ) : (
                ...
                <ScrollArea style={{ maxHeight: "200px", width: "100%" }}>
                  <div className="flex flex-col gap-1 p-2">
                    {inputTracks.map((track) => {
                      ...
                      const isChecked =
                        settings.selectedInputTracks.includes(trackId);
                      return (
                        <div
                          key={trackId}
                          ...
                          onClick={() => {
                            if (isChecked) {
                              updateSetting(
                                "selectedInputTracks",
                                settings.selectedInputTracks.filter(
                                  (id) => id !== trackId,
                                ),
                              );
                            } else {
                        ...
                        >
                          ...
                          >
                            <AudioLines
                              className={`h-4 w-4 ${isChecked ? "text-red-600 dark:text-red-400" : "text-zinc-500 dark:text-zinc-400"}`}
                            />
                          </div>
                          <span
                            className={`text-sm font-medium flex-1 text-left ${isChecked ? "text-red-600 dark:text-red-400" : ""}`}
                          >
                            {track.label}
                          </span>
                          <Checkbox
